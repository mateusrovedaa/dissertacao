...
PARAMS={
 ...
 "MODERATE": dict(ic_fc=120, eps_fc=4,  dc_fc=4,  ic_spo2=180, eps_spo2=1, dc_spo2=1, t_sdt_fc=240,  t_sdt_spo2=360,  ic_max=30*60),
 "LOW":      dict(ic_fc=300, eps_fc=6,  dc_fc=6,  ic_spo2=600, eps_spo2=2, dc_spo2=2, t_sdt_fc=600,  t_sdt_spo2=1200, ic_max=2*3600),
